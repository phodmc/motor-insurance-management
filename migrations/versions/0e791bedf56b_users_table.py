...
Revision ID: 0e791bedf56b
Revises: 
Create Date: 2025-10-28 00:04:58.314442
...
def upgrade():
    ...
    sa.Column('user_type', sa.Enum('UNDERWRITER', 'CASHIER', 'MANAGER', 'ADMIN', name='usertype'), nullable=False),
